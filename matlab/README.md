...
Toolbox, and plots the resulting field lines across the channel opening. Used
to rough-size the solenoids and confirm the field-generation pipeline works
before adding the thruster body/core material in a later pass.
